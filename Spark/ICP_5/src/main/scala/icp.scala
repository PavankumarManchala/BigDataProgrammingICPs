...
object icp {
  def main(args: Array[String]) {
    ...
    val trips_df = spark.read
      ...
      .load("C:\\Courses_Masters\\BigDataProgramming\\Spark\\ICP5\\ICP5\\201508_trip_data.csv")

    val station_df = spark.read
      .format("csv")
      .option("header", "true") //reading the headers
      .option("mode", "DROPMALFORMED")
      .load("C:\\Courses_Masters\\BigDataProgramming\\Spark\\ICP5\\ICP5\\201508_station_data.csv")
    ...
    stationGraph.vertices.write.csv("C:\\Courses_Masters\\BigDataProgramming\\Spark\\ICP5\\ICP5\\Graphs1")

    stationGraph.edges.write.csv("C:\\Courses_Masters\\BigDataProgramming\\Spark\\ICP5\\ICP5\\Graphs1\\graph2")
